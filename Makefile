...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o book.o clothing.o movie.o datastore2.o
...
datastore2.o: datastore2.cpp datastore.h datastore2.h product.h user.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c datastore2.cpp
